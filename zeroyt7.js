...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Follow IG mr.lucifer086',
			error: {
...
varr =
`Hallo ${pushname} I'M HannGanzz have a nice day`
lett =
`𝐁𝐨𝐭 𝐈𝐧𝐟𝐨
Creator : HannGanzz
Prefix : Multi Prefix
...
📸 Youtube  COMING SOON
📰 Instagram
https://instagram.com/mr.lucifer086
📺Tiktok
https://tiktok.com/aelah28
📌 Github
https://github.com/HannGanzz
❋────────────────────────❋`
but = [
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe HannGanzz`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe HannGanzz`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe HannGanzz' })
fs.unlinkSync(ran)
})
break
...
case 'youtube':
teks =
`Nih Youtube Owner Ku Jangan Lupa Di Subscribe Ya https://youtube.com`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/mr.lucifer086`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@aelah28`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
...
├ Sc Full Fitur = 
├─────────────────────
├ Creator Base = HannGanzz
├ Creator Sc = HannGanzz
└─────────────────────`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
...
case 'harrypotter':
if (args.length == 0) return reply(`Teks Nya Mana ?\nContoh: ${prefix + command} HannGanzz`)
zerr = args.join(" ")
buffer = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${zero}&text=${zerr}`)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: '*©Creator : HannGanzz*'})
break
case 'phkomen':
...
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: '*©Creator : HannGanzz*' })
})
break
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe HannGanzz'})
break
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe HannGanzz'})
})
break
case 'darkjoke':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe HannGanzz'})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe HannGanzz'})
break
case 'asupanhijaber':
